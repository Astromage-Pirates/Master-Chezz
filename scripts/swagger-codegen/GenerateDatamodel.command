...
modelsPath="ret/MasterChezz/API/Model/"
apiPath="../../src/MasterChezz/Assets/MasterChezz/Scripts/API/Model"

testsPathSrc="ret/API/Models/Test/"
testsPathDst="../../src/MasterChezz/Assets/MasterChezz/Scripts/Editor/API/Model/Tests"

source ./config.sh

curl --remote-name https://apidocs.saritasa.io/MasterChezz/develop/MasterChezz-latest.yaml -k

java -cp "UnityCodegen-swagger-codegen-1.0.0.jar;swagger-codegen-cli.jar" io.swagger.codegen.v3.cli.SwaggerCodegen generate \
-l UnityCodegen \
-i MasterChezz-latest.yaml \
-c config.json \
-o ret
